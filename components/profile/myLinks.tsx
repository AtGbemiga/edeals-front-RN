...
import wishListIcon from "../../assets/icon.png";
import paymentIcon from "../../assets/icon.png";
import addressIcon from "../../assets/icon.png";
import walletIcon from "../../assets/icon.png";
import groupsIcon from "../../assets/icon.png";
import messagesIcon from "../../assets/icon.png";
import logoutIcon from "../../assets/icon.png";
import expandRightIcon from "../../assets/icon.png";
